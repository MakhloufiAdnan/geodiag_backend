...
describe("/api/orders", () => {
  ...
  beforeEach(async () => {
    ...
    await Promise.all([
      pool.query(
        "TRUNCATE TABLE companies, users, offers, orders RESTART IDENTITY CASCADE"
      ),
    ...
    const offerRes = await pool.query(
      "INSERT INTO offers (name, price, duration_months) VALUES ('Order Offer', 199.99, 12) RETURNING offer_id"
    );
