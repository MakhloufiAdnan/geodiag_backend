...
import { NotFoundException, ConflictException } from '../../src/exceptions/apiException.js';
...
describe('CompanyController', () => {
    ...
    describe('getCompanyById', () => {
        ...
        it('doit appeler next(error) si le service lève une NotFoundException', async () => {
            ...
            // Assert
            expect(companyService.getCompanyById).toHaveBeenCalledWith('uuid-inconnu');
            expect(mockRes.status).not.toHaveBeenCalled();
            expect(mockRes.json).not.toHaveBeenCalled();
    ...
    describe('createCompany', () => {
        ...
        it('doit appeler next(error) si le service lève une ConflictException', async () => {
            // Arrange
            const companyData = { name: 'Existing Company', email: 'existing@co.com' };
            const conflictError = new ConflictException('Cette compagnie existe déjà.');
            mockReq.body = companyData;
