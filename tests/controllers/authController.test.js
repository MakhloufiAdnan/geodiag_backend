...
describe('AuthController', () => {
    ...
    describe('loginCompany', () => {
        ...
        it('doit créer un cookie et retourner un accessToken en cas de succès', async () => {
            const authResult = { accessToken: 'access', refreshToken: 'refresh', user: { id: 1 } };
            ...
            expect(mockRes.json).toHaveBeenCalledWith({ accessToken: 'access', user: { id: 1 } });
        });
    ...
    describe('loginTechnician', () => {
         ...
         */
        it('doit créer un cookie et retourner un accessToken en cas de succès', async () => {
            const authResult = { accessToken: 'tech-access', refreshToken: 'tech-refresh', user: { id: 2 } };
            ...
            expect(mockRes.cookie).toHaveBeenCalledWith('refreshToken', 'tech-refresh', expect.any(Object));
            expect(mockRes.status).toHaveBeenCalledWith(200);
            expect(mockRes.json).toHaveBeenCalledWith({ accessToken: 'tech-access', user: { id: 2 } });
        });
