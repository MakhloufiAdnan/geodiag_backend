...
class OfferService {
    ...
    async #invalidateOffersCache() {
        try {
            ...
            logger.error({ err }, 'Erreur lors de l\'invalidation du cache des offres.');
        }
    }
    ...
    async getAllOffers(authenticatedUser) {
        ...
        try {
            ...
            logger.error({ err }, 'Erreur lors de la lecture du cache Redis pour les offres.');
        }
        ...
        try {
            ...
            logger.error({ err }, 'Erreur lors de l\'écriture dans le cache Redis pour les offres.');
        }
